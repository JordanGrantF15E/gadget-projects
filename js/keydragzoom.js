  ...
  */
  ...
  DragZoom.prototype.onMouseMove_ = function (e) {
    ...
    if (this.dragging_) {
      ...
      // Selection rectangle:
      try{
	this.boxDiv_.style.top = top.toString() + "px";
	this.boxDiv_.style.left = left.toString() + "px";
	this.boxDiv_.style.width = ((width - (this.boxBorderWidths_.left + this.boxBorderWidths_.right))<=0?1:(width - (this.boxBorderWidths_.left + this.boxBorderWidths_.right))).toString() + "px";
	this.boxDiv_.style.height = ((height - (this.boxBorderWidths_.top + this.boxBorderWidths_.bottom))<=0?1:(height - (this.boxBorderWidths_.top + this.boxBorderWidths_.bottom))).toString() + "px";
	this.boxDiv_.style.display = "block";
      }
      catch(E1){
	alert("DragZoom error: " + E1.message);
